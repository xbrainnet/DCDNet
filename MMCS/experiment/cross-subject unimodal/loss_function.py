...
def loss_function1(class_Coefficient, class_block, f_list, f_list1, zf_list, out_y, cls, y, w_c, w_s, w_b, w_sum):
    ...
    loss = 0.2*loss_class + loss_reconstruction_class
    # loss = loss_class
...
def loss_function(class_Coefficient, domain_Coefficient, class_block, domain_block, f_list, f_list1, zf_list, f_list2, df_list, out_y, out_d, cls, y, w_c, w_s, w_b, w_sum):
    ...
    loss_reconstruction = loss_reconstruction_class + loss_reconstruction_domain
    ...
    loss = 0.2*loss_class + loss_reconstruction
    # loss = loss_class
    # print("loss_class:", loss_class)
    # print("loss-GCCA:", loss_gcca/n)
    # print("loss-coe:", loss_coe/n)
